<?php
// $Id: comment_new.php,v 1.1 2007/02/23 05:27:27 nobu Exp $
//  ------------------------------------------------------------------------ //
...
$res = $xoopsDB->query("SELECT m.*, title FROM ".MESSAGE." m,".FORMS." WHERE msgid=$com_itemid AND status<>'x' AND fidref=formid");
