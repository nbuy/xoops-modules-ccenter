...
define( '_AM_FORM_PRIM_DESC', 'W�hlen Sie die Mitglieder der Gruppe, The contact person need select by uid argument from the group' );
...
define( '_AM_MSG_DEL', 'L�schen' );

define( '_AM_MSG_CTIME', 'Registerd' );
define( '_AM_MSG_MTIME', 'Aktualisiert' );

define( '_AM_MSG_UPDATED', 'Status ge�ndert' );
...
define( '_AM_FORM_DELETED', 'Formular gel�scht' );
...
reply_comment=Nachricht hinzuf�gen in automatische E-Mail
reply_use_comtpl=Hinzuf�gen Nachricht an e-Mail-Vorlage
input_mail_confirm=Verwenden Sie best�tigen, Eingang f�r E-Mail-Adresse
...
' );
define( '_AM_EMAIL_LOGIN_NOCONF', 'ohne Best�tigung' );
